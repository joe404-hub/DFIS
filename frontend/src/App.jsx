...
export default function App() {
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh", bgcolor: "#020806", color: "#eefaf4", position: "relative" }}>
      <style>{`
      ...
      >
        <Toolbar sx={{ justifyContent: "space-between", minHeight: 64, px: 3 }}>
          ...
          <Stack direction="row" spacing={1.5} alignItems="center">
            ...
            >
              <FingerprintIcon sx={{ color: "#3dffae", fontSize: 18 }} />
            </Box>
            <Box>
              <Stack direction="row" spacing={0.8} alignItems="center">
                <Typography variant="h6" sx={{ fontWeight: 800, letterSpacing: "-0.02em", color: "#eefaf4", fontSize: 15.5 }}>
                  DFIS
                </Typography>
                <Box sx={{ width: 6, height: 6, borderRadius: "50%", bgcolor: "#3dffae", boxShadow: "0 0 8px #3dffae" }} />
              </Stack>
              <Typography variant="caption" sx={{ color: "#8fa89d", fontSize: 10, letterSpacing: "0.04em", display: "block" }}>
      ...
      {/* Main Workspace Canvas (Full width when unpinned!) */}
      <Box
        component="main"
        sx={{
          flex: 1,
        ...
        {!detail ? (
          ...
          <Container maxWidth="xl" disableGutters>
            ...
            >
              ...
              <Typography variant="body2" sx={{ color: "#8fa89d", fontSize: 13, maxWidth: 840, mb: 1.8 }}>
            ...
            {/* Hero AI Command Center (The Primary Workspace Interaction) */}
            <Paper
              sx={{
                p: 2.5,
                mb: 3,
            ...
            >
              <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 0.8 }}>
                ...
                <Typography variant="caption" sx={{ color: "#52685e", fontSize: 10.5, fontFamily: "JetBrains Mono, monospace" }}>
                  ⌘ ↵ to analyze
                </Typography>
              </Stack>

              <Typography variant="body2" sx={{ color: "#8fa89d", fontSize: 12.5, mb: 1.2 }}>
              ...
              <Stack direction="row" spacing={0.8} alignItems="center" flexWrap="wrap" useFlexGap sx={{ mt: 1.5 }}>
                ...
                {[
                  ...
                  { label: "Was data copied to USB?", query: "Was confidential data copied to USB?" },
                  { label: "Identify suspicious activity", query: "how could we find the suspicious activity taken place?" },
                  ...
                  >
                    {sug.label} {i < 4 && <span style={{ color: "#2a4a3a", marginLeft: 6 }}>·</span>}
                  </Box>
                ))}
              </Stack>
            </Paper>

            {/* Ingestion Pipeline Bar with Visual Stage Flow */}
            <Paper
              sx={{
                p: 1.6,
                mb: 3,
            ...
            >
              <Stack direction={{ xs: "column", lg: "row" }} spacing={2} justifyContent="space-between" alignItems="center">
                {/* Visual Stages Flow */}
                <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap" useFlexGap sx={{ fontSize: 11, fontFamily: "JetBrains Mono, monospace" }}>
                  <Typography variant="caption" sx={{ color: "#3dffae", fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.08em", mr: 0.5 }}>
                    PIPELINE:
                  </Typography>
                  {[
                    { label: "ACQUIRE", done: true },
                    { label: "VERIFY", done: true },
                    { label: "EXTRACT", done: true },
                    { label: "CORRELATE", done: true },
                    ...
                    <React.Fragment key={st.label}>
                      ...
                      {idx < arr.length - 1 && <span style={{ color: "#2a4a3a" }}>──</span>}
                    </React.Fragment>
                  ))}
                </Stack>
