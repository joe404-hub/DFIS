                      ...
                      >
                        {generator.type === "llm" && !generator.fallback ? (
                          <Stack direction="row" spacing={1.2} alignItems="center">
                            <SmartToyIcon sx={{ color: "#34d399", fontSize: 22 }} />
                            <Box sx={{ flex: 1 }}>
                              <Stack direction="row" justifyContent="space-between" alignItems="center">
                                <Typography variant="subtitle2" sx={{ color: "#34d399", fontWeight: 700, fontSize: 12 }}>
                                  🤖 Generated by Ollama (Local Neural LLM)
                                </Typography>
                                <Chip size="small" label="Verified LLM" sx={{ height: 18, fontSize: 9, fontWeight: 700, bgcolor: "#064e3b", color: "#6ee7b7" }} />
                              </Stack>
                          ...
                          <Stack direction="row" spacing={1.2} alignItems="center">
                            <SecurityIcon sx={{ color: "#4fc3f7", fontSize: 20 }} />
                            <Box sx={{ flex: 1 }}>
                              <Typography variant="subtitle2" sx={{ color: "#81d4fa", fontWeight: 700, fontSize: 12 }}>
                                🛡 DFIS Forensic Assistant (Guidance Mode)
                              </Typography>
                          ...
                          <Stack direction="row" spacing={1.2} alignItems="center">
                            ...
                            <Box sx={{ flex: 1 }}>
                              <Stack direction="row" justifyContent="space-between" alignItems="center">
                                <Typography variant="subtitle2" sx={{ color: "#fbbf24", fontWeight: 700, fontSize: 12 }}>
                                  ⚙ DFIS Grounded Fallback Response
                                </Typography>
                                <Chip size="small" label="Rule-Based Fallback" sx={{ height: 18, fontSize: 9, fontWeight: 700, bgcolor: "#451a03", color: "#fcd34d" }} />
                              </Stack>
