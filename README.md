...
- **AI is an investigative aid, not evidence.**
- **Every finding and attack-chain stage links directly to original evidence IDs and SHA-256 hashes.**
- **General forensic knowledge is strictly separated from case-specific facts via RAG.**
